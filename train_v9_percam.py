...
Date-balanced sampling, trim 100 head/tail, exclude defect dates
"""
import os
...
OUTPUT_DIR = Path("/home/dk-sdd/patchcore/output_v9_percam")
TARGET_SPEC = "596x199"
                    ...
                    if sub.is_dir() and spec_pattern in sub.name:
                        if (sub / "camera_1").is_dir():
                            if DEFECT_FOLDER_PREFIX in sub.name:
                                ...
                                # Non-defect folders in defect date — still exclude
                                pass
                            else:
...
def main():
    ...
    for cam_id in CAMERA_IDS:
        ...
        meta = {
            ...
            "defect_dates_excluded": list(DEFECT_DATES),
            "trim_head": TRIM_HEAD,
            "trim_tail": TRIM_TAIL,
