...
Full-resolution model (output_v5b_full), group 1
...
MODEL_DIR = Path("/home/dk-sdd/patchcore/output_v5b_full/596x199/group_1")
OUTPUT_PATH = Path("/home/dk-sdd/patchcore/output_v5b_full/596x199/group_1/dist_compare.png")
...
def main():
    ...
    plt.suptitle(f'PatchCore v5b-FULL (1920x1200) | 596x199/group_1 | Defect vs Normal', fontsize=14)
    plt.tight_layout()
    ...
    json_path = MODEL_DIR / "dist_compare.json"
